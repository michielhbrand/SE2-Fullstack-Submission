    ...
    <Card class="p-6">
      ...
      <div v-else-if="bankAccounts.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="space-y-3">
            ...
            <div class="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <p class="text-sm font-medium">{{ getAccountTypeDisplay(account.accountType) }}</p>
              </div>
            </div>
          ...
          <div class="mt-6 flex gap-2">
            <button
              class="flex-1 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-sm font-medium transition-colors"
              disabled
            >
              Edit
            </button>
      ...
      <div v-else class="text-center py-12">
        ...
        <p class="mt-1 text-sm text-gray-500">
          Add a bank account to manage payment details.
        </p>
      </div>
    </Card>
        ...
        <div class="ml-3">
          ...
          <div class="mt-2 text-sm text-blue-700">
            <ul class="list-disc list-inside space-y-1">
              <li>Bank account details are used for invoice payment information</li>
              <li>Only active accounts will be displayed on invoices</li>
